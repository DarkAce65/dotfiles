...
TODAY=$(expr `/home/taha/.config/dzen2/utcdammit -d | cut -d "/" -f 1` + 0)
MONTH=$(expr `/home/taha/.config/dzen2/utcdammit -d | cut -d "/" -f 2` + 0)
YEAR=`date +'%Y'`

(echo '^bg(#000000)^fg(#F2EDD7)'`/home/taha/.config/dzen2/utcdammit -c`; echo
\
